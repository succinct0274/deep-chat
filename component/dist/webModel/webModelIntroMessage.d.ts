...
export declare class WebModelIntroMessage {
    ...
    static setUpInitial(init: (files?: FileList) => void, introMessage?: WebModelIntro, chatEl?: HTMLElement): string;
    private static exportFile;
    static setUpAfterLoad(files: File[], introMessage?: WebModelIntro, chatEl?: HTMLElement): string;
}
